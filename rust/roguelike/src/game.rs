...
/// Data structure representing the game state. My vague idea is that it should
/// only provide functionality for mutating itself in a consistent manner.
/// All of the game rules will be implemented as Actions.
